...
namespace UnclutteringYourInbox.Models
{
    ...
    /// <summary>
    /// The sparse reply to model without threshold.
    /// </summary>
    public class SparseReplyToModel2 : ReplyToModel
    {
        #region Variables
        /// <summary>
        ...
        public override void ConstructModel()
        {
            ...
            using (Variable.ForEach(emails))
            {
                ...
                this.RepliedTo[emails] = Variable.GaussianFromMeanAndVariance(score, this.NoiseVariance).Named("noisyScore") > 0;
            }

            this.InitializeEngine();

            this.Engine.OptimiseForVariables = this.Mode == InputMode.Training
                                                   ? new IVariable[] { this.Weight }
